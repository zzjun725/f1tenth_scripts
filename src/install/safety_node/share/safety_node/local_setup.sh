...
: ${AMENT_CURRENT_PREFIX:="/sim_ws/src/install/safety_node"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/safety_node/environment/pythonpath.sh"
