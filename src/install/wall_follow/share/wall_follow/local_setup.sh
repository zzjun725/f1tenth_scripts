...
: ${AMENT_CURRENT_PREFIX:="/sim_ws/src/install/wall_follow"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/wall_follow/environment/pythonpath.sh"
